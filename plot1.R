...
EPC <- read.csv.sql("./data/household_power_consumption.txt", sql = "select * from file where Date = '1/2/2007' or Date = '2/2/2007' ", sep=';', nrows=2075259, stringsAsFactors=F, eol = "\n" ); closeAllConnections()
...
## Saving to png file
dev.copy(png, file="./date/plot1.png", height=480, width=480)
dev.off()
